    ...
    <table border="1" style="border-collapse: collapse; width: 100%; margin: 20px 0;">
      <thead>
        <tr style="background-color: #f2f2f2;">
          ...
          <th style="padding: 12px; text-align: center; font-weight: bold;">개인프로젝트</th>
          <th style="padding: 12px; text-align: center; font-weight: bold;">DockerHub</th>
        </tr>
      </thead>
      <tbody>
  `;
  ...
  tableData.forEach(function (item, index) {
    ...
    tableHTML += `
      <tr style="background-color: ${rowBgColor};">
        ...
        <td style="padding: 10px; text-align: center;">
          <strong>${userName}</strong><br>
          <a href="https://github.com/${githubId}/java2509" target="_blank" 
             style="color: #0066cc; text-decoration: none; font-size: 0.9em;">
            ${item.link8}
          </a>
        </td>
        ...
        <td style="padding: 10px; text-align: center;">
          <strong>${userName}</strong><br>
          <a href="https://github.com/${githubId}/side-proj" target="_blank" 
             style="color: #0066cc; text-decoration: none; font-size: 0.9em;">
            ${item.link13}
          </a>
        </td>
        <td style="padding: 10px; text-align: center;">
          <strong>${userName}</strong><br>
          <a href="https://hub.docker.com/search?q=${githubId}" target="_blank" 
             style="color: #0066cc; text-decoration: none; font-size: 0.9em;">
            ${item.link14}
          </a>
        </td>
